...
public class TextTest {
	...
	protected static long hashFunction(String key) {
		long hash = 0;
	...
	public static void main(String[] args) {
		try {
			/*
			 * Text t = new Text("abcdefg"); String s =
			 * Text.decode(t.getBytes(), 0, t.getLength());
			 * System.out.println(t.toString());
			 * System.out.println(t.getLength()+" "+t.getBytes().length+";");
			 * 
			 * 
			 * long hash = hashFunction(s); System.out.println(hash);
			 */
			...
			// (byte)(literal.charAt(literal.length()-1))/2));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
